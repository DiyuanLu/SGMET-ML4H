...
EXPERIMENT_NAME="sgmet_v5_k7_pretrain_2cls_attnmi_hpo_fold0_cluster0"
DATE_TAG="${DATE_TAG:-$(date +%Y%m%d)}"

# Data: fold 0 only, expert / cluster 0 only.
...
OPTUNA_STUDY_NAME="sgmet_v5_k7_pretrain_2cls_attnmi_fold0_cluster0_lr_wd"
