...
EXPERIMENT_NAME="sgmet_e2e_scratch_semantic_2cls_attnmargin_m90_lam0p5_fd10_cd90"
DATE_TAG="${DATE_TAG:-$(date +%Y%m%d)}"

# Attention-overlap cosine margin: penalize slot attention similarity only above 0.90.
EXPERT_INIT="random"
TRAIN_EXPERTS=1
