...
EXPERIMENT_NAME="sgmet_e2e_scratch_semantic_2cls_attnmargin_m90_lam0p5_fd10_cd90_5cv"
...
# Attention-overlap margin objective
SUMMARY_AUX_LOSS="attention_margin"
...
# Unused by attention-margin loss, but accepted by the generic runner
...
# Identical training setup to the original two-CLS and Attention-MI runs
EPOCHS="${EPOCHS:-80}"
