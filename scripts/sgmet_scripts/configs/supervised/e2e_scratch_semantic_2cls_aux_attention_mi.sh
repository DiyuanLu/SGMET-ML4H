...
EXPERIMENT_NAME="sgmet_e2e_scratch_semantic_2cls_attnmi_b1_t1_lam0p005_fd10_cd90"
DATE_TAG="${DATE_TAG:-$(date +%Y%m%d)}"

# Competitive feature-to-slot assignment: low H(S|J), high H(S), beta=1, temperature=1.
EXPERT_INIT="random"
TRAIN_EXPERTS=1
