...
EXPERIMENT_NAME="sgmet_e2e_scratch_semantic_2cls_aux_none_fd10_cd90"
DATE_TAG="${DATE_TAG:-$(date +%Y%m%d)}"

# Reference condition: identical to the existing 2-CLS scratch model, with no auxiliary loss.
EXPERT_INIT="random"
TRAIN_EXPERTS=1
