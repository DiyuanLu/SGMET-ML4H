...
EXPERIMENT_NAME="sgmet_e2e_scratch_semantic_1cls_attnmi_b1_t1_lam0p005_fd10_cd90_5cv"
...
# 1 CLS has no meaningful cross-slot diversity objective.
SUMMARY_AUX_LOSS="none"
SUMMARY_AUX_WEIGHT=0.0
